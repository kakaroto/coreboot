...
#define PAD_CFG_GPI_EVCFG(pad_, term_, evcfg_, rst_) \
	_PAD_CFG_ATTRS(pad_, term_,		 \
...
#define PAD_CFG_TERM_GPO_EVCFG(pad_, val_, term_, evcfg_, rst_)	\
	_PAD_CFG(pad_, term_, \
	_DW0_VALS(rst_, RAW, NO, evcfg_, NO, NO, NO, NO, NO, NO, \
		GPIO, YES, NO) | PAD_FIELD_VAL(GPIOTXSTATE, val_))
...
/* ISH_SPI_CS# */		PAD_CFG_TERM_GPO_EVCFG(GPP_D9, 0, NONE,
	LEVEL, DEEP),
/* ISH_SPI_CLK */		PAD_CFG_GPI_EVCFG(GPP_D10, NONE, LEVEL, DEEP),
/* ISH_SPI_MISO */		PAD_CFG_TERM_GPO_EVCFG(GPP_D11, 1, NONE,
	LEVEL, DEEP),
